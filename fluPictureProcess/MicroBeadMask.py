...
def run_flu_signal_regnize(center_dist, split_dir, out_dir):
    ...
    for i in range(w_h):
        ...
        for j in range(w_h):
            ...
            # 自动识别参数，并进行荧光信息加强
            blacks,whites,gammas = MicroBeadMask.calc_auto_BGR_cutoff(img)
    ...
    MicroBeadMask.store_flu_signal_2_file(outfile=outfile, flu_signal=ori_signal_sets)
    outfile = f"{out_dir}/signal_en.txt"
    MicroBeadMask.store_flu_signal_2_file(outfile=outfile, flu_signal=en_signal_sets)
...
if __name__ == '__main__':
    run_flu_signal_regnize(34.66511715612573, 'D:/delete/chip_one_project/cycle_4/', 'd:/delete/flusplit5/')
